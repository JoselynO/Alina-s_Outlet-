...
@section('title', 'Alina Luxury Outlet')
...
@section('content')
                                    ...
                                    <div class="portfolio-item" >
                                        <a class="portfolio-link" href="{{ route('products.index', ['category' => $category->id]) }}" >
                                            ...
                                            @if($category->image != Category::$IMAGE_DEFAULT)
                                                <img class="img-fluid"  src="{{ asset('storage/' . $category->image) }}" alt="{{ $category->name }}" style="height: 6cm; width: 6cm; object-fit: cover;" onerror="this.onerror=null; this.src='{{ $category->image }}';"/>
                                            @else
    ...
    <div class="card mb-1 m-4">
        <div class="row col-lg-12">
            <div class="col-md-3">
                <img src="https://media-public.canva.com/olf4c/MAEmEwolf4c/1/s.jpg" class="img-fluid rounded-start" style="height: 200px; width: 300px"  onerror="this.onerror=null; this.src='{{ Category::$IMAGE_DEFAULT }}';">
            </div>
            <div class="col-md-8">
                <div class="card-body">
