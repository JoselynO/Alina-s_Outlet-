...
@section('title', 'Alina Luxury - Payment Method')
                        ...
                        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionExample">
                           <div class="row mx-2">
                               ...
                               <div class="card-body col-6">
                                   ...
                                   <div class="input">
                                       <input type="text" name="lastName" required class="form-control"  value="{{$address->lastName ?? "" }}">
        ...
        <div class="col-md-6">
            ...
            <div class="card">
                ...
                <div class="d-flex justify-content-between p-3">
                    ...
                    <div class="mt-1">
                        <span class="super-month">€ {{ number_format($totalPrice,2) }}</span>
                    </div>
                ...
                <div class="p-3 d-flex justify-content-between">
                    ...
                    <span style="color: red">€ {{number_format($save,2) }}</span>
